      ...
      <div className="container">
        <div className="contact-grid">
          ...
          <div>
            ...
            <h2 className="reveal reveal-delay-1">Let's Build Something <span className="gradient-text">Legendary</span></h2>
          ...
          {/* Right — Form */}
          <div className="glass-card reveal reveal-delay-3" style={{ padding: '2.5rem' }}>
